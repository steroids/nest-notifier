        ...
        for (const phone of [].concat(options.phone)) {
            ...
            try {
                if (!credentials.login) {
                    throw new Error('Wrong SmscCallProvider configuration, please set "notifier.providers.voice.smsc.login" param.');
                }
                if (!credentials.password) {
                    throw new Error('Wrong SmscCallProvider configuration, please set "notifier.providers.voice.smsc.password" param.');
                }
